CREATE TABLE IF NOT EXISTS buyer
 (id_buyer integer NOT NULL,
  ...
  CONSTRAINT number_passport_buyer_uk UNIQUE (number_passport_buyer));
 CREATE SEQUENCE buyer_id_seq START WITH 7 INCREMENT 1;
...
CREATE TABLE deal
 (id_deal integer NOT NULL,
  ...
  CONSTRAINT id_buyer_uk UNIQUE (id_buyer, id_seller, id_apartment, deal_date));
 CREATE SEQUENCE deal_id_seq START WITH 11 INCREMENT 1;
